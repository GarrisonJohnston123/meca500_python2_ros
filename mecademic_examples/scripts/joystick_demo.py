...
class JoystickDemo:
	...
	def __init__(self):
		...
		self.joint_state_pub = rospy.Publisher("/mecademic_joint_desired", JointState, queue_size = 1)
		self.pose_pub = rospy.Publisher("/mecademic_pose_desired", Pose, queue_size = 1)
